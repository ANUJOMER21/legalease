...
public class Datum3 {
    ...
    @Expose
    private Assoicate3 assoicate;
    @SerializedName("order_service_list")
    @Expose
    private List<OrderService> orderServiceList = null;
    ...
    public Assoicate3 getAssoicate() {
        return assoicate;
    }

    public void setAssoicate(Assoicate3 assoicate) {
