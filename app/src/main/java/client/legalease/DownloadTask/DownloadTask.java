...
public class DownloadTask {
    ...
    public DownloadTask(Context context, String downloadUrl, String filename, Uri uri) {
...
//                        public void onClick(DialogInterface dialog, int id) {
//                            File pdfFile = new File(Environment.getExternalStorageDirectory() + filename + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + filename);
                } else
