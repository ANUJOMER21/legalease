 ...
 * Use the {@link ServiceRequestRejected#newInstance} factory method to
...
public class ServiceRequestRejected extends Fragment {
     ...
     * @return A new instance of fragment ServiceRequestRejected.
     */
    // TODO: Rename and change types and number of parameters
    public static ServiceRequestRejected newInstance(String param1, String param2) {
        ServiceRequestRejected fragment = new ServiceRequestRejected();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_service_request_rejected, container, false);
        initView(view);
            ...
            public void onResponse(Call<CustomerRequestListmodel> call, Response<CustomerRequestListmodel> response) {
                if(response.body()==null){
                    ...
                    if(datum2List.size()==0){
                        Log.d("datum2list", "onResponserejected: "+datum2List.size());
                    }
                    else
                    {        GetServiceRequestAdapter getServiceRequestAdapter=new GetServiceRequestAdapter(getActivity(),datum2List);
                        rv_serviceRequest.setAdapter(getServiceRequestAdapter);
                        Log.d("last page", "onResponserejected: "+lastpage+"size "+datum2List.get(datum2List.size()-1).getId());
                        getServiceRequestAdapter.notifyDataSetChanged();}
                }
            }
