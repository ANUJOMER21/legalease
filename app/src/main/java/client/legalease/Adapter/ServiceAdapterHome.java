...
public class ServiceAdapterHome extends RecyclerView.Adapter<ServiceAdapterHome.ViewHolder> {
    ...
    public ServiceAdapterHome(Context context, List<Service> servicesData) {
    ...
    @NonNull
    @Override
    public ServiceAdapterHome.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_services_home, viewGroup, false);


        return new ServiceAdapterHome.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ServiceAdapterHome.ViewHolder viewHolder, int i) {
