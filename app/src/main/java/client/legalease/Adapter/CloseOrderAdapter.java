...
public class CloseOrderAdapter extends RecyclerView.Adapter<CloseOrderAdapter.ViewHolder> {


    public static List<Datum> orderData;
    private Context context;
    String selector = "";
    public CloseOrderAdapter(Context context, List<Datum> orderData, String selector) {
    ...
    @NonNull
    @Override
    public CloseOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_item, parent, false);


        return new CloseOrderAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CloseOrderAdapter.ViewHolder holder, int i) {
        String order="";
        String  company="";
